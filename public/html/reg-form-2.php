...
<form class="nav-panel__form" id="reg-form-2" action="" name="form-2" method="post"
  ...
  <span class="error-php"><?php echo $user->getError('username');?></span>
    ...
    <span class="error-php"><?php echo $user->getError('selecthouse');?></span>
    ...
    <span class="error-php"><?php echo $user->getError('userwishes');?></span>
